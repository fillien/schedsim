...
// CSF (Core Scaling First) DVFS+DPM policy
// Computes minimum active processor count first (m_min), then frequency.
// Prefers reducing cores over reducing frequency.
