...
TEST(PowerDomainTest, Construction) {
    std::vector<CStateLevel> c_states = {
        ...
        {2, CStateScope::DomainWide, Duration{0.01}, Power{10.0}},
    };
...
TEST(PowerDomainTest, CStateScope) {
    std::vector<CStateLevel> c_states = {
        {0, CStateScope::PerProcessor, Duration{0.0}, Power{100.0}},
        {1, CStateScope::DomainWide, Duration{0.01}, Power{10.0}},
    };
