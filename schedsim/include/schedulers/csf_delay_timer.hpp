#ifndef SCHED_CSF_DELAY_TIMER_HPP
#define SCHED_CSF_DELAY_TIMER_HPP
...
class csf_delay_timer : public sched_parallel {
      private:
      ...
      public:
        explicit csf_delay_timer(const std::weak_ptr<engine> sim);
