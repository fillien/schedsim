...
plot 'data-preempt.csv' every ::1 using 1:2 with lines lw 2 lc "purple" title 'grub', \
     ...
     'data-preempt.csv' every ::1 using 1:8 with lines lw 2 lc "green" title 'pa\_f\_min', \
     'data-preempt.csv' every ::1 using 1:11 with lines lw 2 lc "red" title 'pa\_m\_min'
